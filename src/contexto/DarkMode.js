...
// es decir tiene el estado y el setEstado ( darkMode, setDarkMode) pero para usarlo necesito de un Provider
// DarkModeContext.Provider ( <DarkModeContext.Provider value={{ darkMode, setDarkMode }}> )
export const DarkModeContext = createContext(null); // permite crear el contexto la variable o estado global 
...
export const useDarkMode = () => {  // permite usar el contexto  
